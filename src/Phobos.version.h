...
#define SAVEGAME_ID ((VERSION_MAJOR << 24) | (VERSION_MINOR << 18) | (VERSION_REVISION << 12) | (VERSION_PATCH << 6) | (VERSION_EX_PATCH))
...
#define FILE_VERSION VERSION_MAJOR, VERSION_MINOR, VERSION_REVISION, VERSION_PATCH
	...
	#else
		#define BUILD_TYPE_NAME "special build"
	#endif
	...
	#else
		#define GIT_COMMIT_SUFFIX " sp"
	#endif
	#ifdef STR_GIT_REF
		#define GIT_REF_SUFFIX " @ " STR_GIT_REF
	#else
		#define GIT_REF_SUFFIX " @CrimRecya"
	#endif
	#define FILE_VERSION_STR VERSION_LONG_STR "-Recya" _STR(VERSION_EX_PATCH)
